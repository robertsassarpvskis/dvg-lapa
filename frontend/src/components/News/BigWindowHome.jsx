            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent group-hover:bg-gradient-to-t group-hover:from-black/60 group-hover:via-black/30">
                <div className="absolute bottom-0 p-8 text-white">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div 
                            className="group inline-flex items-center text-white/50 group-hover:text-greenDark group-hover:underline transition-colors"
                        >
                            Read More
                            <img 
                                src={IconRG} 
                                alt="x" 
                                className="ml-1 h-8 w-8  transform transition-transform duration-500 ease-in-out group-hover:rotate-180"
                            />
                        </div>
                    </div>
                </div>
